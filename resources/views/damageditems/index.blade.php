<!-- resources/views/damageditems/index.blade.php -->

<x-app-layout>

<h1 class="text-3xl font-bold text-gray-700">Damaged Items</h1>
<div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-800">
                    <div class="overflow-x-auto">
  
                    <h2>Damaged Desktops</h2>
                    <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
    <div class="p-6 text-gray-800">
        <div class="overflow-x-auto">
