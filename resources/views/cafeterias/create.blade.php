    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-3xl font-bold text-gray-700">Add Cafeteria Item</h1>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-800">
                    <form action="{{ route('cafeterias.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="staffnumber" id="staffnumber" class="w-full border-2 border-gray-300 p-2" value="{{ old('staffnumber') }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="itemdescription" id="itemdescription" class="w-full border-2 border-gray-300 p-2" value="{{ old('itemdescription') }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="brandnmodel" class="block text-gray-600 font-bold mb-2">Brand & Model:</label>
                                <input type="text" name="brandnmodel" id="brandnmodel" class="w-full border-2 border-gray-300 p-2" value="{{ old('brandnmodel') }}" required>
                            </div>
                            <div class="mb-4">
