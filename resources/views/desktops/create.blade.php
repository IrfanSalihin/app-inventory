                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="location" id="location" class="w-full border-2 border-gray-300 p-2" required>
                                    ...
                                    <option value="Ibu Pejabat" {{ old('location') == 'Ibu Pejabat' ? 'selected' : '' }}>Ibu Pejabat</option>
                                    <option value="Ar-Rahnu Ketereh" {{ old('location') == 'Ar-Rahnu Ketereh' ? 'selected' : '' }}>Ar-Rahnu Ketereh</option>
                                    <option value="Ar-Rahnu Kota Bharu" {{ old('location') == 'Ar-Rahnu Kota Bharu' ? 'selected' : '' }}>Ar-Rahnu Kota Bharu</option>
                                    <option value="Ar-Rahnu Wakaf Bharu" {{ old('location') == 'Ar-Rahnu Wakaf Bharu' ? 'selected' : '' }}>Ar-Rahnu Wakaf Bharu</option>
                                    <option value="Ar-Rahnu Kampong Bharu" {{ old('location') == 'Ar-Rahnu Kampong Bharu' ? 'selected' : '' }}>Ar-Rahnu Kampong Bharu</option>
                                    <option value="Ar-Rahnu Tanah Merah" {{ old('location') == 'Ar-Rahnu Tanah Merah' ? 'selected' : '' }}>Ar-Rahnu Tanah Merah</option>
                                    <option value="Little Caliphs Reef Rawang" {{ old('location') == 'Little Caliphs Reef Rawang' ? 'selected' : '' }}>Little Caliphs Reef Rawang</option>
                                    <option value="Little Caliphs Sg Buaya" {{ old('location') == 'Little Caliphs Sg Buaya' ? 'selected' : '' }}>Little Caliphs Sg Buaya</option>
                                    <option value="Kafetaria" {{ old('location') == 'Kafetaria' ? 'selected' : '' }}>Kafetaria</option>
                                </select>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="keyboard" id="keyboard" class="w-full border-2 border-gray-300 p-2" required>
                                    <option value="1" {{ old('keyboard') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('keyboard') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <select name="mouse" id="mouse" class="w-full border-2 border-gray-300 p-2" required>
                                    <option value="1" {{ old('mouse') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('mouse') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <select name="pc_cable" id="pc_cable" class="w-full border-2 border-gray-300 p-2" required>
                                    <option value="1" {{ old('pc_cable') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('pc_cable') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <select name="vga_cable" id="vga_cable" class="w-full border-2 border-gray-300 p-2" required>
                                    <option value="1" {{ old('vga_cable') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('vga_cable') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <label for="windows_product_key" class="block text-gray-600 font-bold mb-2">Windows Product Key: (License)</label>
                            ...
                            <div class="mb-4">
                                <label for="microsoft_office_lisence" class="block text-gray-600 font-bold mb-2">Microsoft Office License:</label>
                            ...
                            <div class="mb-4">
                                <label for="year" class="block text-gray-600 font-bold mb-2">Year Purchased:</label>
                                <input type="text" name="year" id="year" class="w-full border-2 border-gray-300 p-2" value="{{ old('year') }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="account_purchase_date" class="block text-gray-600 font-bold mb-2">Account Date Purchase:</label>
                                <input type="date" name="account_purchase_date" id="account_purchase_date" class="w-full border-2 border-gray-300 p-2" value="{{ old('account_purchase_date') }}">
                            </div>
                            <div class="mb-4">
                                <label for="date_purchased" class="block text-gray-600 font-bold mb-2">Date Purchased:</label>
                                <input type="date" name="date_purchased" id="date_purchased" class="w-full border-2 border-gray-300 p-2" value="{{ old('date_purchased') }}">
                            </div>
                            <div class="mb-4">
                                <label for="price" class="block text-gray-600 font-bold mb-2">Price:</label>
                                <input type="text" name="price" id="price" class="w-full border-2 border-gray-300 p-2" value="{{ old('price') }}" required pattern="\d+(\.\d{2})?">
                            </div>
                            <div class="mb-4">
