        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('it.user.dashboard')" :active="request()->routeIs('it.user.dashboard')">
                        {{ __('IT User Dashboard') }}
                    </x-nav-link>
                    @elseif(auth()->user()->isGAUser())
                    <x-nav-link :href="route('ga.user.dashboard')" :active="request()->routeIs('ga.user.dashboard')">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- Add an empty flex container to push the dropdown to the right -->
