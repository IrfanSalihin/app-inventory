            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-8 text-gray-800">
                    ...
                    <div class="mt-8 flex space-x-4">
                        ...
                        <a href="{{ route('upowersupps.export', $upowersupp->id) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Export to Excel</a>
                    </div>
                </div>
            </div>
        </div>
