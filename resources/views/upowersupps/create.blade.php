    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-3xl font-bold text-gray-700">Add UPS</h1>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-800">
                    <form action="{{ route('upowersupps.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="remarks" id="remarks" class="w-full border-2 border-gray-300 p-2" value="{{ old('remarks') }}">
                            </div>
                            <div class="mb-4">
