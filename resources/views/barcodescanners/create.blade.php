    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-3xl font-bold text-gray-700">Add Barcode Scanner</h1>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-800">
                    <form action="{{ route('barcodescanners.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="notes" id="notes" class="w-full border-2 border-gray-300 p-2">{{ old('notes') }}</textarea>
                            </div>
                            <div class="mb-4">
