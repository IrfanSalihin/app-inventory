    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-3xl font-bold text-gray-700">Add Smartphone</h1>
                    ...
                    <form action="{{ route('smartphones.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="ram" id="ram" class="w-full border-2 border-gray-300 p-2" value="{{ old('ram') }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="rom" class="block text-gray-600 font-bold mb-2">ROM (GB):</label>
                                <input type="number" name="rom" id="rom" class="w-full border-2 border-gray-300 p-2" value="{{ old('rom') }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="color" class="block text-gray-600 font-bold mb-2">Color:</label>
                                <input type="text" name="color" id="color" class="w-full border-2 border-gray-300 p-2" value="{{ old('color') }}" required>
                            </div>
                            <div class="mb-4">
                            ...
                            <!-- Add other fields for smartphone details here -->
