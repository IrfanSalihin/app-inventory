    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-3xl font-bold text-gray-700">Other Product List</h1>
                <a href="{{ route('others.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Add Other Product
                </a>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $loop->even ? 'bg-indigo-100' : 'bg-white' }}">
                                    ...
                                    <td class="py-3 px-6 text-left flex">
                                        ...
                                        <form action="{{ route('others.destroy', $other->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this specified ptoduct?')">
                                            @csrf
                                            @method('DELETE')
